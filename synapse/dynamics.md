...
* **GABAA**和**GABAB**：它们是GABA的两类受体，其中GABAA是离子型受体，通常可以产生快速的抑制性电位；而GABAB则为代谢型受体，通常会产生缓慢的抑制性电位。

   
 **图 2-1 生物突触** \(引自 Gerstner et al., 2014 [1](dynamics.md#fn_1)\)  
...
GABAB是一种代谢型受体，神经递质和受体结合后不会直接打开离子通道，而是通过G蛋白作为第二信使来起作用。因此，这里我们用$$[R]$$表示多少比例的受体被激活，并用$$[G]$$表示激活的G蛋白的浓度，$$s$$由$$[G]$$调节，公式如下：
...
\(引自 Sterratt et al., 2011 [2](dynamics.md#fn_2)\)  
