...
这里$$E$$是一个反转电位（reverse potential），它可以决定$$I$$的方向是抑制还是兴奋。例如，当静息电位约为$$-65V$$时，减去比它更低的$$E$$，例如$$-75V$$，将变为正，从而改变公式中电流的方向并产生抑制电流。兴奋性突触的$$E$$一般为比较高的值，如0。
...
现在可以回顾一下我们刚才实现的NMDA模型和GABA<sub>B</sub>模型，它们都是基于电导的模型，在NMDA模型中，$$E=0$$，因此产生兴奋性电流；而在GABA<sub>B</sub>模型中，$$E=-95$$，产生抑制性电流。
