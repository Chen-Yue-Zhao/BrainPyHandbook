...
脉冲神经网络的特点是网络分别建模、计算每个神经元和突触。研究者希望通过这种仿真来观察大规模神经网络的行为，并验证相关理论推导。本节将介绍两个经典的脉冲神经网络模型：Vreeswijk和Sompolinsky（1996）提出的兴奋-抑制平衡网络和Wang（2002）提出的抉择网络。
...
<center><b>Fig.3-5 抉择网络结构（<cite id="reffn_4">Wang，2002<sup><a href="#fn_4">4</a></sup></cite>）</b></center>
